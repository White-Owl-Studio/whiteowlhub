...
export const films: Film[] = [
  {
    ...
    trailer: null,
    card: '/films/the-owls-descent/card.webp',
  },
  {
    numeral: 'II',
    ...
    trailer: null,
    card: '/films/the-one-who-drives-the-truck/card.webp',
    stills: [
      '/films/the-one-who-drives-the-truck/still-1.webp',
      '/films/the-one-who-drives-the-truck/still-2.webp',
      '/films/the-one-who-drives-the-truck/still-3.webp',
      '/films/the-one-who-drives-the-truck/still-4.webp',
      '/films/the-one-who-drives-the-truck/still-5.webp',
      '/films/the-one-who-drives-the-truck/still-6.webp',
    ],
    featured: true,
  },
  {
  ...
  },
  {
    ...
    trailer: null,
    poster: '/films/lets-solve-it/poster.webp',
    stills: [
      '/films/lets-solve-it/still-1.webp',
      '/films/lets-solve-it/still-2.webp',
      '/films/lets-solve-it/still-3.webp',
      '/films/lets-solve-it/still-4.webp',
      '/films/lets-solve-it/still-5.webp',
      '/films/lets-solve-it/still-6.webp',
    ],
  },
  {
    numeral: 'V',
    ...
    credits: { director: 'Michael B. Jacob' },
    trailer: null,
    poster: '/films/dawn/poster.webp',
    stills: [
      '/films/dawn/still-1.webp',
      '/films/dawn/still-2.webp',
      '/films/dawn/still-3.webp',
    ],
  },
  {
    numeral: 'VI',
